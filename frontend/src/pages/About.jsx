    ...
    return (
        <div>
            ...
            <div className="my-10 flex flex-col md:flex-row gap-16">
                <img className="w-full md:w-[450px]" src={assets.about_img} />
                <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
                    <p>
                        ShopSphere was born out of a passion for innovation and
                        a desire to revolutionize the way people shop online.
                        Our journey began with a simple idea: to provide a
                        platform where customers can easily discover, explore,
                        and purchase a wide range of products from the comfort
                        of their homes.
                    </p>
                    <p>
                    ...
                    <p>
                        Our mission at ShopSphere is to empower customers with
